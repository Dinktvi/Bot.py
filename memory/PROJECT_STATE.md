...
- [x] Код запушен в GitHub (последний коммит 06ce418)
- [x] ИИ-ассистент НАСТРОЕН: Groq, модель llama-3.3-70b-versatile,
      ключ пользователя в `/workspace/.env` (gitignored, в GitHub не попадает)
